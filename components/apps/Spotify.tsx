...
const TRACKS = [
    { id: 1, title: "Midnight City", artist: "M83", album: "Hurry Up, We're Dreaming", duration: "4:03", cover: "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?w=150&q=80" },
    { id: 2, title: "Blinding Lights", artist: "The Weeknd", album: "After Hours", duration: "3:20", cover: "https://images.unsplash.com/photo-1619983081563-430f63602796?w=150&q=80" },
    { id: 3, title: "Cyberpunk Theme", artist: "Marcin Przybyłowicz", album: "Cyberpunk 2077", duration: "3:50", cover: "https://images.unsplash.com/photo-1605810230434-7631ac76ec81?w=150&q=80" },
    { id: 4, title: "Nightcall", artist: "Kavinsky", album: "OutRun", duration: "4:18", cover: "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?w=150&q=80" },
    { id: 5, title: "Harder, Better, Faster, Stronger", artist: "Daft Punk", album: "Discovery", duration: "3:44", cover: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=150&q=80" },
    { id: 6, title: "Algorithm", artist: "Muse", album: "Simulation Theory", duration: "4:05", cover: "https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=150&q=80" },
];
            ...
            <div className="h-24 bg-[#181818] border-t border-[#282828] flex items-center justify-between px-4 z-50">
                ...
                <div className="flex flex-col items-center gap-2 w-[40%]">
                    ...
                    <div className="w-full flex items-center gap-2 text-xs text-gray-400 font-mono">
                        <span>0:{(progress / 100 * 243).toFixed(0).padStart(2,'0')}</span>
